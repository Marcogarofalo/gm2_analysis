# $a_{\mu}^W(l)$ {#amu_l_continuum_W}

we interpolate at $L_{ref}= 5.46$ fm
...
df<-Rose::read_fit_P_file("/home/garofalo/analysis/g-2_new_stat/fit_all/amu_W_lphys_Lref_poly__w1_a4OS_a4TM_cov_fit_P.dat")
...
file=sprintf("/home/garofalo/analysis/g-2_new_stat/fit_all/amu_W_lphys_Lref_poly__w1_a4OS_a4TM_cov_fit_data.txt")
df<- read.table(file, header=FALSE, fill=TRUE)
iy<-length(df[1,])-2
...
file=sprintf("/home/garofalo/analysis/g-2_new_stat/fit_all/amu_W_lphys_Lref_poly__w1_a4OS_a4TM_cov_fit_out_n%d_afm.txt",n-1)
...
fig<- myplotly(gg,"","$a^2(\\mbox{fm})$", "$a_{\\mu}^{SD}(s)$", to_print = TRUE)
