...
mt <- read_df("/home/garofalo/analysis/online_measuraments_test/out/E112.dat_output")
all_obs <- Rose::get_all_corr(mt)
df<-NULL
df <- add_corr_to_df("M_{PS}", all_obs, mt, df)
######
# mt1 <- read_df("/home/garofalo/analysis/online_measuraments_test/out/E112_light.dat_output")
