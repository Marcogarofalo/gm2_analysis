...
$$
\begin{cases}
a_{\mu}^{SD}(eq,s)=P[0]+a^2P[1]\\
a_{\mu}^{SD}(op,s)=P[0]+a^2P[2]
\end{cases}
$$


```{r, echo=FALSE, results='asis',  warning=FALSE}
df<-Rose::read_fit_P_file("/home/garofalo/analysis/g-2_new_stat/fit_all/amu_full_a2_MK_cov_fit_P.dat")
...
file=sprintf("/home/garofalo/analysis/g-2_new_stat/fit_all/amu_full_a2_MK_cov_fit_out_n%d_afm.txt",n-1)
