...
./gm2_analysis read_plateaux -p ../../g-2_new_stat/ cA.30.32  -bin 50  -L 32  jack -mu 0.00300  0.010  0.020   0.26500   0.29000   0.30000 three_corr || bad+=("cA.30.32")
...
./m_K_2x2 read_plateaux -p ../../g-2_new_stat/ cB.72.64 -bin 50  -L 64 jack -mu 1.7500e-02  1.8500e-02   0.0006675 0.00072 || bad+=("mK cB.72.64")
