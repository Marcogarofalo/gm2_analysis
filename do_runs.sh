...
./mpi_fpi read_plateaux -p ../../g-2_new_stat/ cA.12.48  -bin 50  -L 48  jack -mu 0.00120 || bad+=("cA.12.48")
...
./mpi_fpi read_plateaux -p ../../g-2_new_stat/ cC.20.48  -bin 50  -L 48  jack -mu 0.0020 || bad+=("mpi cC.20.48")

./mpcac read_plateaux -p ../../g-2_new_stat/ cA.12.48  -bin 50 -L 48 jack -mu 0.00120
./mpcac read_plateaux -p ../../g-2_new_stat/ cC.20.48  -bin 50 -L 48 jack -mu 0.00200
if [  $1 == "first_run" ]
then
...
./m_K_ndata read_plateaux -p ../../g-2_new_stat/  cD.54.96  -bin 50  -L 96  jack -mu  0.00054     0.013        0.00054    0.014 \
                                                                                      0.0004964   0.013557     0.00054  0.013557  || bad+=("mK cD.54.96")
...
./fit_etas jack ../../g-2_new_stat/jackknife/ ../../g-2_new_stat//fit_all_Metas/ ||bad+=("fit eta ")
