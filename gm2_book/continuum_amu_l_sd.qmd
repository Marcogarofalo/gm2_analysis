...
df<-Rose::read_fit_P_file("/home/garofalo/analysis/g-2_new_stat/fit_all/amu_SD_lphys_poly__w1_a4OS_a4TM_cov_fit_P.dat")
...
file=sprintf("/home/garofalo/analysis/g-2_new_stat/fit_all/amu_SD_lphys_poly__w1_a4OS_a4TM_cov_fit_data.txt")
df<- read.table(file, header=FALSE, fill=TRUE)
iy<-length(df[1,])-2
...
file=sprintf("/home/garofalo/analysis/g-2_new_stat/fit_all/amu_SD_lphys_poly__w1_a4OS_a4TM_cov_fit_out_n%d_afm.txt",n-1)
